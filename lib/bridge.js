...
class BridgeRuntime {
  ...
  async ensureRuntimeStates() {
    const instanceObjects = ioPackage.instanceObjects || [];
    for (const obj of instanceObjects) {
      if (!obj || !obj._id) continue;
      await this.adapter.setObjectNotExistsAsync(obj._id, {
        type: obj.type,
        common: { ...(obj.common || {}) },
        native: { ...(obj.native || {}) },
      });
  ...
  async executeAction(payload) {
    ...
    if (action === 'help') {
      return {
        ...
        handbook: {
          adminTab: 'Anleitung',
          html: '/adapter/openclaw-bridge/ANLEITUNG.html',
          markdown: 'docs/de/ANLEITUNG.md',
        },
        envelope: {
