...
**Adapter:** `openclaw-bridge` · **Package:** `iobroker.openclaw-bridge` · **Version:** 0.12.1

The German original shipped in the adapter is `docs/de/ANLEITUNG.md` and `admin/ANLEITUNG.html`.

Open this from Admin: instance **Anleitung** tab, or `http://<host>:8081/adapter/openclaw-bridge/ANLEITUNG.html`.
